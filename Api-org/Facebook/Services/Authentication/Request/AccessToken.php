...
namespace Api\Facebook\Services\Authentication\Request;

use Api\HttpDefaultHandler,
    Api\Thetvdb\Services\Authentication\SecurityService;
use Api\MessageResource as MessageResource;


class AccessToken extends SecurityService {

    public static $host = 'https://graph.facebook.com/login';
